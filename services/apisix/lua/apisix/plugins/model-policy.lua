...
-- All non-reasoning models (shared list for base + student groups)
local CHAT_MODELS = {
...
local ALLOWED_MODELS_BY_GROUP = {
    base_user = CHAT_MODELS,
    students_MTM026_LP4_2026 = CHAT_MODELS,
    teachers_MTM026_LP4_2026 = "*",  -- All models
